  ...
  return (
    <>
      ...
      <section className="mb-8 text-center">
        <div className="mx-auto mb-2 h-9 w-64 animate-pulse rounded-lg bg-gray-200 dark:bg-gray-700" />
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        {Array.from({ length: 6 }).map((_, i) => (
          ...
          >
            ...
            <div className="mb-1 h-6 w-3/4 animate-pulse rounded bg-gray-200 dark:bg-gray-700" />
